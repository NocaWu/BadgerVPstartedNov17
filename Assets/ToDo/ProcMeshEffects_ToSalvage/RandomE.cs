...
//        public static Vector2 onUnitCircle { get { return PTUtils.PointOnCircle2(1, Random.Range(0, 2*Mathf.PI)); } }
        ...
        /// </summary>
        public static Color colorHSV { get { return new ColorExt.ColorHSV(Random.value, 1, 1).ToColor(); } }

        /// <summary>
        /// Returns a gradient between two random colors
        /// </summary>
        public static Gradient gradient { get { return ColorExt.Gradient(color, color); } }

        /// <summary>
        /// Returns a gradient between two random HSV colors
        /// </summary>
        public static Gradient gradientHSV { get { return ColorExt.Gradient(colorHSV, colorHSV); } }
